    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.DateField(validators=[django.core.validators.MinValueValidator(limit_value=datetime.date(1900, 1, 1), message='Дата рождения не может быть ранее 1900 года.'), django.core.validators.MaxValueValidator(limit_value=datetime.date(2024, 3, 4), message='Дата рождения не может быть в будущем.')])),
